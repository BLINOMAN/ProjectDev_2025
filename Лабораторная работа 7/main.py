...
async def provide_user_service(user_repository: UserRepository = Provide(provide_user_repository),
...
async def provide_product_service(product_repository: ProductRepository = Provide(provide_product_repository),
                                   redis: Redis = Provide(provide_redis_client),):
